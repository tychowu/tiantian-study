...
const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    icon: "✖️",
    img: "/images/cards/times-table-v3.jpg",
    accent: "#EF8C2F",
    stars: "點陣・口訣・逆向題",
  ...
  },
  {
    ...
    icon: "🗺️",
    img: "/images/cards/landmark-v2.jpg",
    accent: "#B5712F",
    stars: "照片圖鑑・線索猜猜看",
  ...
  },
  {
    ...
    icon: "💬",
    img: "/images/cards/speaking-v2.jpg",
    accent: "#4AA58B",
    stars: "觀察・組織・說故事",
    comingSoon: true,
  },
